  ...
  return (
    <div>
      <div>
        ...
        <div className='flex items-center gap-3 ml-5 w-full'>
          ...
          <Card className="w-[300px]">
            ...
            <CardContent className='flex'>
              {
                stats?.followingList && <AnimatedTooltip items={stats.followingList}/>
              }{
                stats?.followersList && <AnimatedTooltip items={stats.followersList }/>
              }
            </CardContent>
          </Card>
        </div>
